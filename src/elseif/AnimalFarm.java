...
int a = JOptionPane.showOptionDialog(null, "What animal do you want?", "", JOptionPane.YES_NO_OPTION, JOptionPane.INFORMATION_MESSAGE, null, new String[] {"Cow", "Duck", "Dog"}, null);
if (a==0) {
	playMoo();
}
if (a==1) {
